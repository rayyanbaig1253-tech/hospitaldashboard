...
function SalesPage() {
    ...
    const addToCart = (product)=>{
        ...
        const amountToAdd = product.stock >= unitsPerPack ? unitsPerPack : product.stock;
        if (existingItem) {
            if (existingItem.quantity + 1 > product.stock) return;
    ...
    const updateUnifiedQuantity = (productId, strips, tablets)=>{
        setCart((prevCart)=>{
            ...
            // Cap at stock
            const finalUnits = Math.min(totalUnits, item.stock);
    ...
    const totalItemDiscount = cart.reduce((sum, item)=>{
        // Strip discount only applies for each FULL strip sold
        const strips = Math.floor(item.quantity / item.unitsPerPack);
        return sum + strips * (item.discount || 0);
    }, 0);
    ...
    const completeSale = async ()=>{
        ...
        try {
                ...
                body: JSON.stringify({
                    items: cart.map((item)=>{
                        return {
                            ...
                            isPiece: true // Store as unit sales for backend
                        };
                    }),
                    total,
                    tax,
            ...
            if (res.ok) {
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$Hospital__Dashboard$2f$hospital$2d$dashboard$2f$lib$2f$pdf$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateInvoicePDF"])({
                    ...
                    items: cart.map((item)=>{
                        ...
                        let qtyDisplay = "";
                        if (strips > 0 && tablets > 0) qtyDisplay = `${strips} S + ${tablets} T`;
                        else if (strips > 0) qtyDisplay = `${strips} Strip`;
                                                                        ...
                                                                        children: [
                                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$Hospital__Dashboard$2f$hospital$2d$dashboard$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                                ...
                                                                                children: [
                                                                                    ...
                                                                                    item.quantity >= item.stock && item.quantity % item.unitsPerPack === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$Hospital__Dashboard$2f$hospital$2d$dashboard$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                            ...
                                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$Hospital__Dashboard$2f$hospital$2d$dashboard$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                                ...
                                                                                children: [
                                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$Hospital__Dashboard$2f$hospital$2d$dashboard$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                                                        onClick: ()=>updateUnifiedQuantity(item.productId, strips - 1, tablets),
                                                                    ...
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$Hospital__Dashboard$2f$hospital$2d$dashboard$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                        ...
                                                                        children: [
                                                                            ...
                                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$Hospital__Dashboard$2f$hospital$2d$dashboard$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                                ...
                                                                                children: [
                                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$Hospital__Dashboard$2f$hospital$2d$dashboard$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                                                        onClick: ()=>updateUnifiedQuantity(item.productId, strips, tablets - 1),
                                                                                        className: "px-3 bg-gray-50 text-gray-400 hover:text-purple-600 active:bg-gray-100 transition-colors border-r border-gray-100 font-bold",
                                                                                        children: "-"
                                                                                    }, void 0, false, {
                                                                                        fileName: "[project]/Downloads/Hospital Dashboard/hospital-dashboard/app/sales/page.tsx",
                                                                                    ...
                                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$Hospital__Dashboard$2f$hospital$2d$dashboard$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                                                                        ...
                                                                                        inputMode: "numeric",
                                                                                        value: tablets,
                                                                                        onChange: (e)=>updateUnifiedQuantity(item.productId, strips, parseInt(e.target.value) || 0),
                                                                                        className: "w-full text-center font-black text-gray-900 border-none bg-transparent text-sm focus:ring-0 p-0"
                                                                                    }, void 0, false, {
                                                                                        fileName: "[project]/Downloads/Hospital Dashboard/hospital-dashboard/app/sales/page.tsx",
                                                                                        lineNumber: 367,
                                                                    ...
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$Hospital__Dashboard$2f$hospital$2d$dashboard$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                        ...
                                                                        children: [
                                                                            ...
                                                                            10
                                                                                ...
                                                                                onClick: ()=>updateUnifiedQuantity(item.productId, strips, q),
...
_s(SalesPage, "NwZkSF5Mg8GZNY/IsCmNefPmP8Q=", false, function() {
    return [
...
//# sourceMappingURL=Downloads_Hospital%20Dashboard_hospital-dashboard_6c951b01._.js.map