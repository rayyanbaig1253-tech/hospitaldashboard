...
function ExpiryScanner({ onScanComplete, onClose, productName }) {
    ...
    const simulateScan = async (imageData, fileName)=>{
        ...
        try {
            ...
            // Try Professional OCR API First
            ...
            const detected = [
                {
                    ...
                    expiryDate: parsed.exp || formatDateToISO(new Date(new Date().setFullYear(new Date().getFullYear() + 2)))
                }
            ];
...
"[project]/Documents/Hospital Dashboard/hospital-dashboard/app/purchases/page.tsx [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {

const e = new Error("Could not parse module '[project]/Documents/Hospital Dashboard/hospital-dashboard/app/purchases/page.tsx'\n\nExpected '}', got '<eof>'");
...
//# sourceMappingURL=Documents_Hospital%20Dashboard_hospital-dashboard_28b84c7b._.js.map