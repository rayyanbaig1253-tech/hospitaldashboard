            ...
            if (data.items && data.items.length > 0) {
                const formatted = data.items.map((item)=>{
                    ...
                    return {
                        ...
                        purchasePrice: parseFloat(rateVal.toFixed(2)),
                        discountPercent: parseFloat(discPctVal.toFixed(2)),
                        taxPercent: parseFloat(taxPctVal.toFixed(2)),
                        netAmount: parseFloat(netVal.toFixed(2)),
                        effectiveCost: totalQtyVal > 0 ? parseFloat((netVal / totalQtyVal).toFixed(2)) : parseFloat(rateVal.toFixed(2)),
                        remarks: item.remarks || (discPctVal > 0 ? `Disc: ${discPctVal.toFixed(1)}%` : "✨ Gemini AI Mapped"),
                                                                        ...
                                                                        children: [
                                                                            ...
                                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Hospital__Dashboard$2f$hospital$2d$dashboard$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                                                                ...
                                                                                onChange: (e)=>{
                                                                                    ...
                                                                                    // Update item code if product selected
                                                                                    const selectedProd = products?.find((p)=>p.id === prodId);
                                                                                    if (selectedProd) {
                                                                                        newItems[idx].itemCode = selectedProd.item_code;
...
//# sourceMappingURL=Documents_Hospital%20Dashboard_hospital-dashboard_34de174f._.js.map